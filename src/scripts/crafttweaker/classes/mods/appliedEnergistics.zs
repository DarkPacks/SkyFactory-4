...
zenClass AppliedEnergistics {
	...
	*/
	function addInscriber(output as IItemStack, input as IIngredient, inscribe as bool) {
		Inscriber.addRecipe(output, input, inscribe);
	}
	function addInscriber(output as IItemStack, input as IIngredient, inscribe as bool, top as IIngredient) {
		Inscriber.addRecipe(output, input, inscribe, top);
	}
	function addInscriber(output as IItemStack, input as IIngredient, inscribe as bool, top as IIngredient, bottom as IIngredient) {
